...
Param (
    ...
    [string]$DeployMode = '<%=$PLASTER_PARAM_DeployMode%>',
    [Parameter(Mandatory=$false)]
...
Try {
    ...
    [string]$appName = '<%=$PLASTER_PARAM_ToolkitName%>'
    [string]$appVersion = '<%=$PLASTER_PARAM_Version%>'
    [string]$appArch = ''
    [string]$appLang = 'EN'
    [string]$appRevision = '01'
    [string]$appScriptVersion = '1.0.0'
    [string]$appScriptDate = '<%=$PLASTER_DATE%>'
    [string]$appScriptAuthor = '<%=$PLASTER_PARAM_Author%>'
    ##*===============================================
    ...
    ## Call the Exit-Script function to perform final cleanup operationss
